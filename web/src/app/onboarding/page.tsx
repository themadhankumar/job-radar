        ...
        {step === 0 && (
          <section>
            ...
            <label className="surface flex cursor-pointer flex-col items-center rounded-lg border-dashed p-8 text-sm hover:border-[rgb(var(--accent))]">
              <input type="file" accept=".pdf,.docx,.tex,.txt,.md,text/x-tex,application/x-tex,application/pdf,application/vnd.openxmlformats-officedocument.wordprocessingml.document,text/plain,text/markdown" className="hidden"
